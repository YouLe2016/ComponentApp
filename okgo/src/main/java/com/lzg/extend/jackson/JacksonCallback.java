                ...
                if (rawType == BaseResponse.class) {
                    ...
                    if (typeArgument instanceof ParameterizedType) {
                        ...
                        if (rawTypeInner == ArrayList.class) {
                            ...
                            JSONArray jsonArray = new JSONObject(json).optJSONArray("result");
                            baseResponse.result = JsonUtil.toList(jsonArray == null ? "[]" : jsonArray.toString(), clazzArgument);
                        ...
                        BaseResponse baseResponse = new BaseResponse();
                        JSONObject jsonObject = new JSONObject(json).optJSONObject("result");
                        baseResponse.result = JsonUtil.jsonToBean(jsonObject == null ? "{}" : jsonObject.toString(), clazzArgument);
